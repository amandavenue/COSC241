...
public class Tower{
    ...
    /** method returns height as an int.
        @return int (number of blocks in tower (height))
    */
    public int height(){
        if (isEmpty()){
            return 0;
    ...
    /** calculates hwo many blocks in tower are the same as c.
        @param c (char to calculate in tower)
        @return int (number of occurances of c in tower)
    */
